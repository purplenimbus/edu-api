...
class SchoolTermTest extends TestCase
{
  ...
  public function testHasEnrolledStudents()
  {
    $this->seed(DatabaseSeeder::class);
    $institution = new Institution();
    $schoolTerm = $institution->newSchoolTerm($this->user->tenant, 'first term');
    ...
    $this->registerStudent($schoolTerm, $student1, $course1);
    $this->registerStudent($schoolTerm, $student2, $course1);
    $this->registerStudent($schoolTerm, $student1, $course2);
    $this->registerStudent($schoolTerm, $student2, $course2);
    $this->registerStudent($schoolTerm, $student1, $course3);
    $this->registerStudent($schoolTerm, $student2, $course3);

    $this->assertEquals($schoolTerm->enrolledStudents()->pluck('id')->toArray(), [$student1->id, $student2->id]);
  }
